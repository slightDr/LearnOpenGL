...
int Learn1()
{
    ...
    // ------------------------------------
    std::string root = "4_lightingmaps/";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // material
        {
			lightingShader.setInt("material.diffuse", 0);  // 设置diffuse绑定纹理单元0
...
int Learn2()
{
    ...
    //unsigned int specularMap = loadTexture((root + "textures/lighting_maps_specular_color.png").c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            lightingShader.setInt("material.diffuse", 0);  // 设置diffuse绑定纹理单元0
			lightingShader.setInt("material.specular", 1);  // 设置specular绑定纹理单元1
            lightingShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f);
            lightingShader.setFloat("material.shininess", 64.0f);
        }
        // light
...
int Practice1()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // material
        {
            lightingShader.setInt("material.diffuse", 0);  // 设置diffuse绑定纹理单元0
            lightingShader.setInt("material.specular", 1);  // 设置specular绑定纹理单元1
			lightingShader.setInt("material.emission", 2);  // 设置emission绑定纹理单元2
            lightingShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f);
            lightingShader.setFloat("material.shininess", 64.0f);
        }
        // light
