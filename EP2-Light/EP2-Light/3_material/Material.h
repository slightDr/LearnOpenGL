...
int Learn1()
{
    ...
    // ------------------------------------
    Shader lightingShader("3_material/shaders/Object.vs", "3_material/shaders/Object.fs");
    Shader lightCubeShader("3_material/shaders/Light.vs", "3_material/shaders/Light.fs");
