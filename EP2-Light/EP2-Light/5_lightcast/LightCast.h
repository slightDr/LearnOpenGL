...
int Learn1()  // 平行光源
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light
        {
            ...
            lightingShader.setVec3("light.direction", -0.2f, -1.0f, -0.3f);  // 设置光源方向
        }
...
int Learn2()  // 点光源（带衰减）
{
    ...
    // ------------------------------------
    std::string root = "5_lightcast/";
    Shader lightingShader((root + "shaders/Object.vs").c_str(), (root + "shaders/Object2.fs").c_str());
    Shader lightCubeShader((root + "shaders/Light.vs").c_str(), (root + "shaders/Light.fs").c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light
        {
            ...
            lightingShader.setVec3("light.diffuse", 0.5f, 0.5f, 0.5f);
            lightingShader.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
            lightingShader.setFloat("light.constant", 1.0f);  // 衰减系数
...
int Learn3()  // spotlight 聚光
{
    ...
    // ------------------------------------
    std::string root = "5_lightcast/";
    Shader lightingShader((root + "shaders/Object.vs").c_str(), (root + "shaders/Object3.fs").c_str());
    Shader lightCubeShader((root + "shaders/Light.vs").c_str(), (root + "shaders/Light.fs").c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light
        {
            ...
            lightingShader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));  // 软边缘
